                        ...
                        <div class="htc__product__rightidebar">
                            <div class="htc__grid__top">
                                ...
                                <ul class="view__mode" role="tablist">
                                    <li role="presentation" class="grid-view active"><a href="#grid-view" role="tab" data-toggle="tab"><i class="zmdi-grid zmdi"></i></a></li>
                            ...
                            <div class="row">
                                <div class="shop__grid__view__wrap">
                                    <div role="tabpanel" id="grid-view" class="clearfix single-grid-view tab-pane fade in active">
                                    ...
                                    <div role="tabpanel" id="list-view" class="clearfix single-grid-view tab-pane fade">
                                        <div class="col-xs-12">
