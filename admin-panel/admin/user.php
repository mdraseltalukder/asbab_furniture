                              ...
                              <table class="table">
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          <?php 
                                           echo '<a class="bg-danger pt-1 pr-2 pb-1 pl-2 rounded text-white text-whitebg-danger" href="delete.php?&id=' . $contact['id'] . '&created_date=' . $contact['created_at'] . '">Delete</a>';
                                           ?>
                                       </td>
